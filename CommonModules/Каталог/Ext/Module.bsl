...
Функция ПолучитьСписокНоменклатуры(НаименованиеВида)    
	...
	Пока Результат.Следующий() Цикл
		Номенклатура   = НайтиПоАртикулу(Результат.Артикул);
		Цена           = ПолучитьЦену(Номенклатура);
		ОписаниеСЦеной = "Цена: " + Строка(Цена) + " руб. " + Результат.Описание;
		
		Наименование   = ?(СтрДлина(Результат.Наименование) > 80, Лев(Результат.Наименование, 80), Результат.Наименование);  
		Описание       = ?(СтрДлина(ОписаниеСЦеной) > 80, Лев(ОписаниеСЦеной, 80), ОписаниеСЦеной);  
